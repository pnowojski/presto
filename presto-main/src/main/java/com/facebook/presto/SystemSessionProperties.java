...
public final class SystemSessionProperties
{
    ...
    public static final String DISTRIBUTION_CONCURRENCY = "distribution_concurrency";
            ...
            FeaturesConfig featuresConfig)
    {
        sessionProperties = ImmutableList.of(
                ...
                integerSessionProperty(
                        ...
                        "Default number of local parallel partitioners per local exchange",
                        1,
                        false),
                booleanSessionProperty(
    ...
    public static int getDistributionConcurrency(Session session)
    {
        return session.getSystemProperty(DISTRIBUTION_CONCURRENCY, Integer.class);
    }
