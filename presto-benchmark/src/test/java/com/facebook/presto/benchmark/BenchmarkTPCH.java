...
public class BenchmarkTPCH
{
    ...
    @Benchmark
    public void q02(Context context)
    {
        context.run(TPCHQueries.getQuery("q02"));
    }

    @Benchmark
    public void q03(Context context)
    {
        context.run(TPCHQueries.getQuery("q03"));
    }

    @Benchmark
    public void q04(Context context)
    {
        context.run(TPCHQueries.getQuery("q04"));
    }
}
